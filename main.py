...
@client.slash_command(name = "code", description = "Link zum GitHub Repository", guild_ids=[server_id])
async def code(interaction: Interaction):
    await interaction.response.send_message("https://github.com/DieMeister/ButterBot")
